	...
	if user_input == ("1"): #GAME 1. Colour Guess
		...
		if user_input3 == ("yes"):
			...
			if user_input2 == ("no"):
				...
				print ("Okay! Pick a new game: ")
	elif user_input == ("Blue Bubbles"):
		answer = input("What is the velocity of a swallow? ")
		if answer == ("African or European?"):
			print ("Good answer. Play the games now, you cheeky snot")
			keep_playing = True
		else:
			print ("You fool. I fart in your general direction. Your mother was a hamster and your father smelled of elderberries!")
			keep_playing = True
	else:
